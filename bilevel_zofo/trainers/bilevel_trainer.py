...
#     MistralConfig
# )
# from ..data.tasks import get_tasks
# from ..utils import *
#
...
#
#     # @torch.no_grad()
#     def zo_hyper_step(self, model, inputs):
#         """
...
#
#         # train lower level problem (prompt tuning) with perturbed full parameters
#         print('start lower level training for loss 1')
...
#             self.zo_perturb_parameters(scaling_factor=-1)
#             # train lower level problem (prompt tuning) with unperturbed full parameters
#             print('start lower level training for loss 2')
#             self.lower_level_train(model)
