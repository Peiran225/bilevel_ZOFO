#!/bin/bash
#SBATCH --job-name=ft_base_bilevel  # Specify a name for your job
#SBATCH --output=outputs/ft_baseline.log       #   Specify the output log file
#SBATCH --error=errors/ft_baseline.log #      # Specify the error log file
...
wandb agent pyu123/zo-bench/1y5c2xcu