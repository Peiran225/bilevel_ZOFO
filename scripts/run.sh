#!/bin/bash
#SBATCH --job-name=base_bilevel  # Specify a name for your job
#SBATCH --output=outputs/bilevel_base.log       # AUC_converge.log  Specify the output log file
#SBATCH --error=errors/bilevel_base.log # AUC_p_tuning_main_errors.log         # Specify the error log file
