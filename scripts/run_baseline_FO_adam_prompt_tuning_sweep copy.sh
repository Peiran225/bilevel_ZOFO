...
#SBATCH --output=outputs/baseline.log       #   Specify the output log file
#SBATCH --error=errors/baseline.log #      # Specify the error log file
...
wandb agent pyu123/zo-bench/3p49kg50