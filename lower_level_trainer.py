...
class LowerLevelTrainer(Trainer):
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            if self.args.eval_steps is not None and (total_steps + 1) % self.args.eval_steps == 0:
                    ...
                    if "accuracy" in test_metrics:
                        self.log({"lower_test_acc": test_metrics["accuracy"]})#, "val_acc": val_metrics["accuracy"]})
                        wandb.log({"lower_test_acc": test_metrics["accuracy"]})#, "val_acc": val_metrics["accuracy"]})
                    else:
